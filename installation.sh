...
echo -e "\033[1;92m❤️  Welcome to ACCsi Forex Terminal!\033[0m"
...
echo -e "  \033[1;95m• Contacts Refiner\033[0m"
echo -e "    Run command: \033[1;97mrefine\033[0m"
echo ""
...
EOL
        ...
        if [[ "${ubuntu_choice,,}" != "n" ]]; then
            ...
            sed -i '/# Custom ACCsi Forex Terminal/,/End ACCsi Forex Terminal Banner/d' ~/.bashrc
...
# End ACCsi Forex Terminal Banner
